...
public class ProdcutControllerTest {
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.result[3].product_id", equalTo(4)))
                .andExpect(jsonPath("$.result[4].product_id", equalTo(2)));
    }
    ...
    public void getProducts_pagination() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.result", hasSize(2)))
                .andExpect(jsonPath("$.result[0].product_id", equalTo(5)))
                .andExpect(jsonPath("$.result[1].product_id", equalTo(4)));
    }
}